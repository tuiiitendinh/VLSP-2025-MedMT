...
python vlsp_moe/scripts/train_tokenizer.py --config /home/users/sutd/1010047/VLSP-2025-MedMT/vlsp_moe/configs/moe_config.yaml --output_dir /home/users/sutd/1010047/VLSP-2025-MedMT/vlsp_moes/tokenizer_output
...
if [ -f "data/processed/val.jsonl" ];
    python /home/users/sutd/1010047/VLSP-2025-MedMT/vlsp_moe/scripts/evaluate_moe.py --model_path outputs/moe_model --interactive
else
