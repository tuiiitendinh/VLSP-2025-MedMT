...
def main():
    ...
    default_config_path = os.path.join(PROJECT_ROOT, "configs", "moe_config.yaml")
    parser.add_argument(
        "--config",
        type=str,
    ...
    default_tokenizer_dir_path = os.path.join(PROJECT_ROOT, "tokenizer_output")
    parser.add_argument(
        "--tokenizer_dir",
        type=str,
        default=default_tokenizer_dir_path,
